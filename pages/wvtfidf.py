...
st.subheader('Modellerin karşılaştırılması')
#show the model plots from img folder
st.subheader('WAVELET Sonuçları')
...
st.dataframe(allscores[(allscores.index.str.startswith("tf"))])


st.subheader('Custom modellerin en iyi sonuç veren grafikleri')
